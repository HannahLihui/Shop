...
new Vue({
    ...
    methods: {
    	recentOrder(){
    		this.$http.post('/recentOrder.do').then(result => {
    			this.order.itemtitle=result.body.itemtitle;
                 this.order.address=result.body.address;
                  this.order.phone=result.body.phone;
               this.order. price=result.body.price;
